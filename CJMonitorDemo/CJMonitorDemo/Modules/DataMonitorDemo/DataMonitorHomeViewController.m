//
//  DataMonitorHomeViewController.m
//  CJNetworkDemo
//
...
@interface DataMonitorHomeViewController ()

@end

@implementation DataMonitorHomeViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.navigationItem.title = NSLocalizedString(@"DataMonitor首页", nil);
