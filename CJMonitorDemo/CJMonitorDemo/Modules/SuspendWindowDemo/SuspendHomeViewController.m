...
@interface SuspendHomeViewController ()

@end

@implementation SuspendHomeViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.navigationItem.title = NSLocalizedString(@"Suspend首页", nil);
